inventory: inventory_system.o src/inventory_logic.o src/draw.o src/manage_data.o src/utility.o
	gcc inventory_system.o src/inventory_logic.o src/draw.o src/manage_data.o src/utility.o -o inventory
